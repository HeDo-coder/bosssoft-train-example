 ...
 * @since 1.0
 **/
public abstract class AbstractOrganizationDao<T,M extends Mapper<T>>   extends AbstractBaseDao <Organization, OrganizationMapper>  implements OrganizationDao<Organization, OrganizationQuery> {
